...
type IApplicationTransactionService interface {
	FindAll(userId uuid.UUID) []dto.TransactionDto
	FindById(id int64, userId uuid.UUID) (*dto.TransactionDto, error)
	Save(transactionDto *dto.TransactionDto) error
	CreateOrUpdate(transactionDto *dto.TransactionDto, userId uuid.UUID) (error, string)
	Delete(transactionDto *dto.TransactionDto, userId uuid.UUID) error
}
...
func (s *ApplicationTransactionService) FindAll(userId uuid.UUID) []dto.TransactionDto {
...
func (s *ApplicationTransactionService) FindById(id int64, userId uuid.UUID) (*dto.TransactionDto, error) {
...
func (s *ApplicationTransactionService) CreateOrUpdate(transactionDto *dto.TransactionDto, userId uuid.UUID) (error, string) {
...
func (s *ApplicationTransactionService) Delete(transactionDto *dto.TransactionDto, userId uuid.UUID) error {
