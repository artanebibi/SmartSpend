...
type User struct {
	...
	RefreshToken           string    `gorm:"size:255" json:"refresh_token"` // generated by provider_token_id
	RefreshTokenExpiryDate time.Time `json:"refresh_token_expiry_date"`     // 30 days after each log in
